...
class TransactionServiceTest {
  ...
  inner class GetPrisonerTransactionsByAccountId {
    ...
    fun `Should return empty list if given an empty list`() {
      ...
      whenever(generalLedgerApiClient.getStatementForAccountId(prisonerId, null, null, credit = true, debit = true, pageNumber = 1, pageSize = 25, subAccountId = null)).thenReturn(
      ...
      val response = transactionService.getPrisonerTransactionsByAccountId(prisonerId, null, null, credit = true, debit = true, pageNumber = 1, pageSize = 25, subAccountId = null)
