...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-prisoner-finance-api/security/policy).
...
## Renaming from HMPPS Prisoner Finance Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-prisoner-finance-api=0
```
